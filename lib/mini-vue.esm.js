...
const createRenderer = (options) => {
    ...
    function patchChildren(n1, n2, container, parentComponent) {
        ...
        if (preShapeFlag & 8 /* TEXT_CHILD */) {
            ...
            else if (shapeFlag & 8 /* TEXT_CHILD */) {
                if (c2 !== c1) {
...
export { createApp, createElement, createRenderer, createTextVNode, getCurrentInstance, h, inject, insert, patchProp, provide, proxyRefs, ref, renderSlots, setElementText };
